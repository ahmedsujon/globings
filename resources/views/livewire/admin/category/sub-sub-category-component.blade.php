        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Sub-Sub Category</h4>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-white" style="border-bottom: 1px solid #e2e2e7;">
                            <h4 class="card-title" style="float: left;">All Sub-Sub Category</h4>
                                ...
                                <table class="table align-middle table-nowrap table-bordered mb-0">
                                    ...
                                    <tbody>
                                        @if ($sub_sub_categories->count() > 0)
                                            @php
                                                $sl = $sub_sub_categories->perPage() * $sub_sub_categories->currentPage() - ($sub_sub_categories->perPage() - 1);
                                            @endphp
                                            @foreach ($sub_sub_categories as $sub_sub_category)
                                                <tr>
                                                    <td class="text-center">{{ $sl++ }}</td>
                                                    <td>{{ $sub_sub_category->name }}</td>
                                                    <td class="text-center">{{ $sub_sub_category->slug }}</td>
                                                    <td class="text-center" style="width: 15%;">
                                                        @if ($sub_sub_category->status == 0)
                                                            <button class="btn btn-xs btn-danger"
                                                                wire:click.prevent='changeStatus({{ $sub_sub_category->id }})'
                                                                style="font-weight: normal; font-size: 11px; padding: 1px 7px;">{!! loadingStateStatus('changeStatus(' . $sub_sub_category->id . ')', 'In-Active') !!}</button>
                                                        @else
                                                            <button class="btn btn-xs btn-success"
                                                                wire:click.prevent='changeStatus({{ $sub_sub_category->id }})'
                                                                style="font-weight: normal; font-size: 11px; padding: 1px 7px;">{!! loadingStateStatus('changeStatus(' . $sub_sub_category->id . ')', 'Active') !!}</button>
                                                        @endif
                                                    </td>
                                                    <td>{{ getCategoryID($sub_sub_category->parent_id)->name }}</td>
                                                    <td>{{ getCategoryID($sub_sub_category->parent_id)->name }}</td>
                                                    <td class="text-center">
                                                        <button
                                                            class="btn btn-sm btn-soft-primary waves-effect waves-light action-btn edit_btn"
                                                            wire:click.prevent='editData({{ $sub_sub_category->id }})'
                                                        ...
                                                        <button
                                                            ...
                                                            wire:click.prevent='deleteConfirmation({{ $sub_sub_category->id }})'
                                                            wire:loading.attr='disabled'>
                        ...
                        <div class="card-footer bg-white">
                            {{ $sub_sub_categories->links('livewire.pagination-links') }}
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background: white;">
                            <h5 class="modal-title m-0" id="mySmallModalLabel">Add New Sub-Sub Category</h5>
                                ...
                                <div class="col-md-11">
                                    <form wire:submit.prevent='storeData'>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <label class="col-md-5 col-form-label">Select Category</label>
                                            ...
                                            <div class="col-md-6 mb-2">
                                                <label class="col-md-5 col-form-label">Select Sub Category</label>
                                                <select class="form-select" wire:model.blur='sub_category_id'>
            ...
            <div wire:ignore.self class="modal fade" id="editDataModal" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-dialog-zoom modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header" style="background: white;">
                            <h5 class="modal-title m-0" id="mySmallModalLabel">Edit Sub-Sub Category</h5>
...
@push('scripts')
    <script>
        ...
        window.addEventListener('sub_sub_category_deleted', event => {
