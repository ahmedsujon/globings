            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Private Account</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                <li class="breadcrumb-item active">Private Account</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header bg-white" style="border-bottom: 1px solid #e2e2e7;">
                            <h4 class="card-title" style="float: left;">All Private Account</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table align-middle table-nowrap table-bordered mb-0">
                                    ...
                                    <tbody>
                                        @if ($private_accounts->count() > 0)
                                        @php
                                        $sl = $private_accounts->perPage() * $private_accounts->currentPage() -
                                        ($private_accounts->perPage() - 1);
                                        @endphp
                        ...
                        <div class="card-footer bg-white">
                            {{ $private_accounts->links('livewire.pagination-links') }}
                        </div>
                    </div>
                </div>
            </div>
