<div>
    <div class="pb-100">
        <div class="recent_post_modal">

            <div class="container">
                <div class="bing_back_area">
                    <div class="d-flex align-items-center flex-wrap g-xl">
                        <h4 class="notification_title">Recent Posts</h4>
                    </div>
                </div>

                <form action="" id="searchForm" class="post_search_form">
                    <input type="search" id="search_input" value="{{ request()->get('search') }}"
                        placeholder="Search recent posts" />
                    <img src="{{ asset('assets/app/icons/post_search_icon.svg') }}" alt="search icon"
                        class="search_icon" />
                </form>
                <!-- Post Home Section  -->
                <section class="post_home_wrapper">
                    <div class="container">
                        @if ($posts->count() > 0)
                                ...
                                <div class="post_grid">
                                    <div class="hash_area">
                                        ...
                                        <a href="{{ route('app.shopProfile', ['user_id' => $post->user_id]) }}"
                                            type="button" class="post_user_area">
    ...
    <script>
        $(document).ready(function() {
            $('#searchForm').on('submit', function(e) {
                ...
                window.location.href = "{{ URL::to('/recent-posts') }}?search=" + value;
            });
        ...
        const swiperPostProfile = new Swiper(".post_area .post_slider1", {
            speed: 1150,
            effect: "cards",
            keyboard: {
                enabled: true,
