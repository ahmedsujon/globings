<div>
    @if (request()->is('home'))
        ...
        <!-- Comment Modal  -->
        <div class="comment_modal" id="commentModalArea">
            <div class="container">
                ...
                <div class="comment_wraper">
                    <div>
                        <div class="comment_item nested_comment">
                            <div>
                                <img src="{{ asset('assets/app/images/post/comment_user.png') }}" alt="user " class="comment_user" />
                            </div>
                            <div>
                                <div class="comment">
                                    <h4>Sadiya Mim</h4>
                                    <p>How can I know about this store?</p>
                                </div>
                                ...
                                <div class="info d-flex align-items-center flex-wrap">
                                    ...
                                    <button type="button" class="replayBtn">Reply</button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="comment_item">
                                ...
                                <div>
                                    <div class="comment">
                                        <h4>Foysal Kobir</h4>
                                        <p>
                                            After you register this app and login to know everything
                                            about it
                                        </p>
                                    </div>
            ...
            <form action="" class="comment_form">
                <div class="container">
                    <input type="text" placeholder="Write a comment..." class="input_filed" />
                </div>
            </form>
        </div>
        ...
        <div class="sing_modal_area react_modal_area" id="reactModalArea">
            ...
            <div class="total_react_area d-flex align-items-center flex-wrap g-sm">
                <div class="container">
                    <img src="{{ asset('assets/app/icons/heart_comment_icon.svg') }}" alt="heart icon" class="heart_icon" />
                    <span class="react_title">250</span>
                </div>
            </div>
            <div class="like_user_area">
                <div class="container">
                    <div class="user_grid">
                        <div class="user_img_area">
                            <img src="{{ asset('assets/app/images/post/comment_user2.png') }}" alt="comment user" class="user_img" />
                            <img src="{{ asset('assets/app/icons/heart_comment_icon.svg') }}" alt="heart icon" class="heart_icon" />
                        </div>
                        <h4>Tuffajol Hossain</h4>
                    </div>
                    <div class="user_grid">
                        <div class="user_img_area">
                            <img src="{{ asset('assets/app/images/post/comment_user2.png') }}" alt="comment user" class="user_img" />
