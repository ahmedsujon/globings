...
class PrivateAccountComponent extends Component
{
    ...
    {
        $private_accounts = User::where('account_type', 'Private')->where('first_name', 'like', '%' . $this->searchTerm . '%')->orderBy('id', 'DESC')->paginate($this->sortingValue);
        $this->dispatch('reload_scripts');
        return view('livewire.admin.accounts.private-account-component', ['private_accounts' => $private_accounts])->layout('livewire.admin.layouts.base');
    }
}
